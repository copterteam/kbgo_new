    ...
    <div class="page text-center">
          ...
          <nav data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fullwidth" data-lg-layout="rd-navbar-fullwidth" data-lg-device-layout="rd-navbar-fullwidth" class="rd-navbar">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a href="index.html" class="brand-name">Industrial</a></div>
      ...
      <main class="page-content">
        ...
        <section class="section-35 section-sm-top-75 section-sm-bottom-145">
          <div class="shell">
            <div class="range range-xs-middle range-sm-center text-left">
                ...
                <div class="rd-navbar-search rd-navbar-search-inline">
                  <form action="search.php" method="GET" class="rd-navbar-search-form">
                    <label class="rd-navbar-search-form-input">
                      <input type="text" name="s" placeholder="keyword" autocomplete="off"><span class="rd-navbar-live-search-results"></span>
                    </label>
                    <button type="submit" class="btn btn-lg btn-rect btn-default-variant-1">Search</button>
                  </form>
                </div>
              </div>
            </div>
            <div class="range offset-top-75 offset-md-top-100">
              <div class="cell-xs-12">
