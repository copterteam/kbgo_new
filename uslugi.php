...
<html lang="en" class="wide wow-animation">
  <head>
    <!-- Site Title-->
    <title>Услуги аэрофотосъемки, высотного обследования | КБ Горбунова А.А.</title>
  ...
  <body>
   ...
   <?include("header.php"); ?>
      ...
      <main class="page-content">
        ...
        <!-- Additional services-->
        <section class="section-35 section-sm-bottom-150 text-center">
          <div class="shell">
            <div class="range">
        ...
        <section data-on="false" data-lg-on="true" class="rd-parallax bg-gray-darker">
          <div data-speed="0.2" data-type="media" data-url="images/services-05-2050x506.jpg" class="rd-parallax-layer"></div>
          <div data-speed="0" data-type="html" class="rd-parallax-layer">
            <div class="section-75 section-sm-100">
              <div class="shell">
        ...
        <!-- Our facilities-->
        <section class="section-75 section-sm-bottom-150 text-center">
          <div class="shell">
            <div class="range range-sm-center">
